...
# 保存路径
DATA_DIR = os.path.expanduser('/home/lin/mobile-aloha/data')
# DATA_DIR = "/home/lin/aloha/mobile-aloha/act/data"
...
TASK_CONFIGS = {
    'aloha_mobile_dummy':{
        ...
        'num_episodes': 61   # 需要跟数据集里面的回合对应上
    },
...
### ALOHA fixed constants ALOHA固定参数
DT = 0.02 # 时间间隔
FPS = 50  # 频率
# 关节名称
