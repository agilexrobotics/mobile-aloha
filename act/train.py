...
def train(args):
    ...
    train_dataloader, val_dataloader, stats, _ = load_data(dataset_dir, num_episodes, camera_names, args.batch_size, args.batch_size)
    # save dataset stats
    ...
    best_ckpt_info = train_process(train_dataloader, val_dataloader, config)
...
def train_process(train_dataloader, val_dataloader, config):
...
def get_arguments():
    ...
    parser.add_argument('--onscreen_render', action='store', type=bool, help='onscreen_render', default=True, required=False)
