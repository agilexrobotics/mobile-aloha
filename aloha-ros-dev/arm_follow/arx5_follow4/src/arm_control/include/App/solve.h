...
public:
    ...
    arx5_state fk_calc(command arx_cmd_t,float *back_pos,float *send_pos,bool control_mode_t);
    // ros::NodeHandle nh;
    ...
    arx5_state kdl_ik_calc(command arx_cmd_t,float *back_pos,float *send_pos,bool control_mode_t);
