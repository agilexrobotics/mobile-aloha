...
void arx_arm::motor_control()
{
    ...
    if(current_normal)
    {
        ...
        float teach_k=1.0f;
                ...
                usleep(200);
        /////////////////////////////torque/////////////////////////////////////
                CAN_Handlej.Can_cmd_all (2, 0, 0, 0, 0,  solve.jointTorques(1)*teach_k);
                usleep(200);
                CAN_Handlej.Can_cmd_all (4, 0, 0, 0, 0,  solve.jointTorques(2)*teach_k);
                usleep(200);
                CAN_Handlej.Send_DM_Moto(5, 0, 0, 0, 0,  solve.jointTorques(3));
                usleep(200);
                CAN_Handlej.Send_DM_Moto(6, 0, 0, 0, 0,  solve.jointTorques(4));
                usleep(200);
                CAN_Handlej.Send_DM_Moto(7, 0, 0, 0, 0,  solve.jointTorques(5));
                usleep(200);        
