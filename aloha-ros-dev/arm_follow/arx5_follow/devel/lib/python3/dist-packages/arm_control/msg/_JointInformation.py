...
class JointInformation(genpy.Message):
  _md5sum = "07ea87c1a9d81347441927ac49537ad0"
...
float32[7] joint_cur
int32 mode"""
  __slots__ = ['joint_pos','joint_dev','joint_cur','mode']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       joint_pos,joint_dev,joint_cur,mode
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_7f().pack(*self.joint_dev))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joint_dev = _get_struct_7f().unpack(str[start:end])
      start = end
      end += 28
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(self.joint_dev.tostring())
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joint_dev = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=7)
      start = end
      end += 28
